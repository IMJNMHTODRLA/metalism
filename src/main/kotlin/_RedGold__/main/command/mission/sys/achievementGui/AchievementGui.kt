...
class AchievementGui(private val plugin: JavaPlugin) {
    fun openGui(player: Player, sendSound: Float = 1f) {
        ...
        i(10, 0, "일일 접속을 200회", 200, "&a&l[시간의 연속] 칭호 지급, &d&l효율 VI 네더라이트 곡괭이 지급")
        i(11, 1, "플레이어 처치를 200회", 200, "&4&l[킬러] 칭호 지급, &d&l날카로움 V, 발화 III 네더라이트 검 지급")
        ...
        i(24, 12, "불사의 토템 발동을 200회", 200, "&d&l폭팔로부터 보호 IV, 보호 II 네더라이트 레깅스 지급")
        i(25, 13, "황금 사과 섭취를 300회", 300, "&b&l30 캐시 지급, &e&l마법이 부여된 황금 사과 1개 지급")

        i(28, 14, "위더 처치를 20회", 20, "&e&l강타 V, 발화 III 네더라이트 검 지급")
