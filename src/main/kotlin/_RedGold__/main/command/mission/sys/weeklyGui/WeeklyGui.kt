...
class WeeklyGui(private val plugin: JavaPlugin) {
    fun openGui(player: Player, sendSound: Float = 1f) {
        ...
        i(19, 0, "일일 접속을 5회", 5, "&a&l경험치 병 5개 지급")
        i(20, 1, "일일 상점 아이템 구매를 5회", 5, "&d&l엔드 수정 5개 지급")
        i(21, 2, "블록 파괴를 500회", 100, "&d&l리스폰 정박기 5개 지급")
        i(22, 3, "모루 손상을 2회", 2, "&a&l경험치 병 5개 지급")
        i(23, 4, "위더 스켈레톤 처치를 9회", 9, "&6&l10,000 골드 지급")
        i(24, 5, "플레이어 처치를 5회", 5, "&b&l6 캐시 지급")
        i(25, 6, "주간 미션을 5회 클리어", 5, "&b&l10 캐시 지급")
