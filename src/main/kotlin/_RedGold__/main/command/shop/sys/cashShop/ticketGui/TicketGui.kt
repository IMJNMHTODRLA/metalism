    ...
    fun openGui(player: Player, sound: Float = 1f) {
        ...
        gui.setItem(13, getItem(
            ...
            listOf(
                ...
                "",
                "&f&l뽑기에서 각 회차마다 개별적으로 5%의 확률로 치장품이 등장 합니다.",
                "&f&l95% 확률로 실패 할 시 20,000 골드가 지급됩니다.",
                "&f&l만일 5% 확률로 성공 시 치장품에서 사망/킬 사운드는 각각 1.45%,",
                "&f&l접속 메시지는 1.30%, 칭호는 0.80% 확률로 등장합니다.",
                "",
                "&c&l만일 기존에 장착, 또는 구매를 한 치장품이 나올 시 20,000 골드로 변경됩니다.",
                "&c&l오직 치장품만 뽑을 수 있으며 키트 아이템은 안 나옵니다.",
                "&c&l사망/킬 사운드, 접속 메시지 치장품이 뽑기로 나올 시 장착을 안하면 20,000 골드로 변경됩니다.",
                "",
