...
class GoldGui(private val plugin: JavaPlugin) {
    fun openGui(player: Player) {
        ...
        gui.setItem(4, getItem("enchanted_book", "&f&l인첸트 북 상점"))

        gui.setItem(12, getItem("golden_carrot", "&f&l음식 상점"))
        gui.setItem(13, getItem("end_crystal", "&d&lCPVP 상점"))
        gui.setItem(14, getItem("iron_ingot", "&f&l광물 상점"))

        gui.setItem(22, getItem("wheat", "&f&l농작물 상점"))
