...
import _RedGold__.main.command.ranking.sys.playTimeGui.PlayTimeGui
import _RedGold__.main.command.ranking.sys.selectGui.SelectGui
import _RedGold__.main.command.ranking.sys.streakGui.StreakGui
...
class Ranking : CommandExecutor, TabExecutor {
    override fun onCommand(
        ...
        else if (args[0] == "cash") CashGui().openGui(player, 0)
        ...
        else if (args[0] == "playtime") PlayTimeGui().openGui(player, 0)
        else if (args[0] == "streak") StreakGui().openGui(player, 0)
    ...
    override fun onTabComplete(
        ...
        if (args.size == 1) return listOf("boost", "cash", "death", "gold", "kill", "playtime", "streak")
        return emptyList()
    }
}
