package _RedGold__.main.command.transfer
...
@RequireCommandExecutor("transfer", "user", "&c/<command> <플레이어> <금액>", ["송금", "pay", "보내기"])
@RequireTabExecutor
class Transfer : CommandExecutor, TabExecutor {
    override fun onCommand(
        ...
        player.sendMessage(gc("$toPlayerStylePrefix$toRankPrefix${toName}&f&l에게 &2&l") + sendMessages)
