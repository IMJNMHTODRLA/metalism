...
class InfoGui {
    fun openGui(player: Player) {
        ...
        gui.setItem(14, getItem(
            ...
            listOf(
                "",
                "&a&lA. &f&l추가적으로 후원을 할 경우 100원에 1 캐시씩 지급을 합니다.",
                "       &c&l단, 무과금 유저와의 게임 밸런스를 위하여 일주일에 최대 10,000원 까지 후원이 가능합니다.",
                "       &c&l만일 그 이상을 후원할 시 환불이 불가능하며 캐시는 지급되지 않습니다."
            )
        ))
        ...
        gui.setItem(23, getItem(
            ...
            listOf(
                "",
                "&a&lA. &f&l네, 누적 후원 금액이 10,000원 이상일 때 혜택이 적용됩니다."
            )
        ))
