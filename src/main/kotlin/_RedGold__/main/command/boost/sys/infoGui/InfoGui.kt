...
class InfoGui {
    fun openGui(player: Player) {
        ...
        gui.setItem(12, getItem(
            ...
            listOf(
                "",
                "&a&lA. &f&l저희 서버는 누적 후원 금액 30,000원 이상 후원 시 영구 혜택을 지급됩니다.",
                "",
                "       &f&l혜택은 다음과 같습니다.",
                "&7&l=======================================================",
                "   &a&l[ 영구 혜택 ]",
                "       &7&l- &b&lPLUS 랭크 지급",
                "       &7&l- &a&l탭 리스트 우선 표시",
                "       &7&l- &e&lGG 메시지 색깔 변경 및 각종 메시지 변경 가능",
                "       &7&l- &b&l250 캐시 지급",
                "       &7&l- &e&l화살 경로에 파티클 표시(비활성화 가능)",
                "",
                "   &b&l[ 월정액 혜택 ] &7&l(매달 20,000원 후원 시 유지)",
                "       &8&l* 영구 혜택 획득 이후 이용 가능",
                "       &7&l- &e&l50 캐시 지급(매 주)",
                "       &7&l- &e&l일일 접속 시 본인에게 12캐시와 80,000 골드, 1레벨 지급",
                "       &7&l- &e&l서버 전체 유저에게 매일 4캐시와 1레벨 지급(하루 1회)",
                "       &7&l- &e&l접속 시 강조된 접속 메시지 전달(비활성화 가능)",
                "       &7&l- &e&l매뉴에서 엔더 상자 열기 가능(PVP 중에는 불가능)",
                "&7&l======================================================="
            )
        ))
