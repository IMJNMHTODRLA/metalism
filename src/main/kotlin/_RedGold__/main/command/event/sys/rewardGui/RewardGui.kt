        ...
        */
        ...
        when (page) {
            1 -> {
                ...
                i(12, 2, 300_000, "&6&l10,000 골드 지급")
                i(13, 3, 400_000, "&b&l마법이 부여된 책(강타 II) 지급") //
                i(14, 4, 500_000, "&d&l엔드 수정 4개 지급")
                i(15, 5, 600_000, "&b&l5 캐시 지급")
                i(16, 6, 700_000, "&b&l마법이 부여된 책(강타 II) 지급") //

                i(19, 7, 800_000, "&a&l1 레벨 증가")
                i(20, 8, 900_000, "&6&l50,000 골드 지급")
                i(21, 9, 1_000_000, "&b&l치장품 5연뽑 지급") //
                i(22, 10, 1_500_000, "&d&l리스폰 정박기 5개 지급")
                i(23, 11, 2_000_000, "&2&l5 토큰 지급")
                i(24, 12, 2_500_000, "&b&l마법이 부여된 책(폭발로부터 보호 III) 지급") //
                i(25, 13, 3_000_000, "&a&l경험치 병 15개 지급")

                i(28, 14, 3_500_000, "&6&l80,000 골드 지급")
                i(29, 15, 4_000_000, "&b&l치장품 5연뽑 2회 지급") //
                i(30, 16, 4_500_000, "&a&l10 캐시 지급")
                i(31, 17, 5_000_000, "&d&l엔드 수정 8개 지급")
                i(32, 18, 6_000_000, "&b&l마법이 부여된 책(날카로움 III) 지급") //
                i(33, 19, 7_000_000, "&a&l10 레벨 증가")
                i(34, 20, 8_000_000, "&6&l500,000 골드 지급")

                i(37, 21, 9_000_000, "&b&l마법이 부여된 책(수선) 지급") //
                i(38, 22, 10_000_000, "&d&l리스폰 정박기 20개 지급")
                i(39, 23, 12_000_000, "&d&l엔드 수정 25개 지급")
                i(40, 24, 14_000_000, "&b&l마법이 부여된 책(수선) 지급, &b&l마법이 부여된 책(보호 IV) 지급")
                i(41, 25, 16_000_000, "&6&l500,000 골드 지급, &b&l50 캐시 지급")
                i(42, 26, 18_000_000, "&a&l경험치 병 35개 지급, &a&l20 레벨 증가")
                i(43, 27, 20_000_000, "&b&l치장품 5연뽑 2회 지급, &b&l80 캐시 지급")
