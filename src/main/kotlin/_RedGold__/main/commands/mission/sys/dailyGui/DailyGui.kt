...
class DailyGui(private val plugin: JavaPlugin) {
    ...
    fun openGui(player: Player, sendSound: Float = 1f) {
        ...
        i(19, 0, "일일 접속", 1, "&6&l5,000 골드 지급")
        i(20, 1, "일일 상점 아이템 구매", 1, "&6&l5,000 골드 지급")
        i(21, 2, "블록 파괴를 16회", 16, "&6&l5,000 골드 지급")
        i(22, 3, "블록 설치를 16회", 16, "&6&l5,000 골드 지급")
        i(23, 4, "위더 스켈레톤 처치를 3회", 3, "&6&l10,000 골드 지급")
        i(24, 5, "플레이어 처치를 1회", 1, "&6&l10,000 골드 지급")
        i(25, 6, "일일 미션을 5회 클리어", 5, "&b&l1 캐시 지급")
