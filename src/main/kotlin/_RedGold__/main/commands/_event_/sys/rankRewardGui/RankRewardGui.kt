...
import _RedGold__.main.commands._event_.sys.rankRewardGui.RankRefresh.EventRank.eventTier
import _RedGold__.main.commands._event_.sys.rankRewardGui.RankRefresh.EventRank.isLoading
    ...
    fun openGui(player: Player, page: Int) {
        ...
        gui.setItem(48, getPlayerSkull(
            ...
            listOf(
                ...
                "&f&l이벤트 누적 점수: &d&l${point[uuid]?.toFormat()?: "-"}점",
                "&e&l이벤트 최고 점수: &d&l${bestPoint[uuid]?.toFormat()?: "-"}점",
                "",
