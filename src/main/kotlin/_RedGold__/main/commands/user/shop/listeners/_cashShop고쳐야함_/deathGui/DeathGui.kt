package _RedGold__.main.commands.user.shop.listeners._cashShop고쳐야함_.deathGui
...
class DeathGui(private val plugin: JavaPlugin) {
    ...
    fun openGui(player: Player, sound: Float = 1f) {
        ...
        //50 캐시 = 1 뽑기 포인트
        10.fi("선택 안함", 0, 0) //
        11.fi("물에 빠진", 14, 1) //minecraft:entity.player.splash 1.0
        12.fi("귀신", 14, 2) //minecraft:ambient.cave 1.0
        13.fi("비", 14, 3) //minecraft:weather.rain 1.0
        14.fi("흑우", 15, 4) //minecraft:entity.cow.death 1.0
        15.fi("박쥐", 15, 5) //minecraft:entity.bat.death 1.0
        16.fi("돼지", 15, 6) //minecraft:entity.pig.death 1.0

        19.fi("모루", 15, 7) //minecraft:block.anvil.land 1.0
        20.fi("부숴진", 16, 8) //minecraft:item.totem.use 2.0
        21.fi("폭팔", 17, 9) //minecraft:entity.generic.explode
        22.fi("먹다", 14, 10) //minecraft:entity.generic.eat
        23.fi("타버림", 14, 11) //minecraft:entity.generic.extinguish_fire
        24.fi("금고 부숨", 15, 12) //minecraft:block.vault.break
        25.fi("웅장한 브금(김)", 21, 13) //minecraft:music.credits
