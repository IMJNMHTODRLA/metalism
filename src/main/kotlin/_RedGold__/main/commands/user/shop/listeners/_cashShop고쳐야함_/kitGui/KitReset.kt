package _RedGold__.main.commands.user.shop.listeners._cashShop고쳐야함_.kitGui
...
@RequireJavaPlugin
class KitReset(private val plugin: JavaPlugin) {
    init {
        loop()
    }

    private fun loop() {
        val path = plugin.dataFolder.toPath().resolve("kit_shop")
