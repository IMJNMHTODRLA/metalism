...
class KillGui(private val plugin: JavaPlugin) {
    ...
    fun openGui(player: Player, sound: Float = 1f) {
        ...
        10.fi("선택 안함", 0, 0) //
        11.fi("철퇴", 14, 1) //item.mace.smash_ground_heavy 1.0
        12.fi("꿀", 14, 2) //minecraft:block.honey_block.fall 1.0
        13.fi("슬라임", 14, 3) //minecraft:block.slime_block.break 1.0
        14.fi("좀비", 14, 4) //minecraft:entity.zombie.death 1.0
        15.fi("철문 공격", 14, 5) //minecraft:entity.zombie.attack_iron_door 1.0
        16.fi("조글린", 14, 6) //minecraft:entity.zoglin.death 1.0

        19.fi("모루", 14, 7) //minecraft:block.anvil.use 1.0
        20.fi("발전 과제", 15, 8) //minecraft:ui.toast.challenge_complete 1.0
        21.fi("셜커", 14, 9) //minecraft:entity.shulker.ambient
        22.fi("염소뿔", 19, 10) //minecraft:item.goat_horn.sound.1
        23.fi("삼지창", 16, 11) //minecraft:item.trident.riptide_1
        24.fi("웅장한 삼지창", 18, 12) //minecraft:item.trident.thunder
        25.fi("마심", 14, 13) //minecraft:entity.generic.drink
