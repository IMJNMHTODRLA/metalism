package _RedGold__.main.commands.boost

import _RedGold__.main.commands.boost.sys.admin.Admin
import _RedGold__.main.commands.boost.sys.goDiscord.GoDiscord
import _RedGold__.main.commands.boost.sys.infoGui.InfoGui
import _RedGold__.main.commands.boost.sys.selectGui.SelectGui
...
class Boost(private val plugin: JavaPlugin) : CommandExecutor, TabExecutor {
    override fun onCommand(
        ...
        else if (args[0] == "plus") _RedGold__.main.commands.boost.sys.plusTools.selectGui.SelectGui().openGui(player)
